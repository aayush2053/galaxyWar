...
public class PantallaDificilNivel2 implements Screen{
    ...
    public void show() {
        ...
        nave = new Nave(new Vector2(10,200),new Texture("ship/f1.png"),3,7);
    ...
    private void generarEnemigos(){
        ...
        if(TimeUtils.millis() -tiempoMarciano> Constantes.TIEMPO_ENTRE_MARCIANOS){
            ...
            Marciano marciano = new Marciano(new Vector2(enX,enY),new Texture("enemy/e_f1.png"),vidaMarcianos,7);
        ...
        if(TimeUtils.millis()- tiempoRoca>Constantes.TIEMPO_ENTRE_ROCAS){
            ...
            enY=MathUtils.random(0,Gdx.graphics.getHeight());
            Roca roca = new Roca(new Vector2(enX,enY),texRoca,vidaRocas,7);
            rocas.add(roca);
            tiempoRoca=TimeUtils.millis();
        ...
        if(TimeUtils.millis()- tiempoVida>Constantes.TIEMPO_ENTRE_VIDA){
            ...
            enY=MathUtils.random(0,Gdx.graphics.getHeight());
            Vida vida = new Vida(new Vector2(enX,enY),texVida,vidaMarcianos,2);
            vidas.add(vida);
            tiempoVida=TimeUtils.millis();
        }
        ...
        if(TimeUtils.millis()- tiempoDarth>Constantes.TIEMPO_ENTRE_DARTH){
            ...
            enY=MathUtils.random(0,Gdx.graphics.getHeight());
            Darth darth = new Darth(new Vector2(enX,enY),texDarth,vidaDarth,5);
            darths.add(darth);
            tiempoDarth=TimeUtils.millis();
        }
